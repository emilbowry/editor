...
import {ICodeMapperResponse } from '../../contrib/chat/common/chatCodeMapperService.js';
...
// import {ICodeMapperProgressDto, ICodeMapperRequestDto, MainContext, MainThreadCodeMapperShape } from '../common/extHost.protocol.js';
